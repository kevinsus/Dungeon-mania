...
import dungeonmania.entities.EntityOnMovedAway;
...
public class GameMap {
    ...
    private void triggerMovingAwayEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e != entity && e instanceof EntityOnMovedAway)
                callbacks.add(() -> ((EntityOnMovedAway) e).onMovedAway(this, entity));
        });
    ...
    private void triggerOverlapEvent(Entity entity) {
        ...
        getEntities(entity.getPosition()).forEach(e -> {
            if (e != entity && e instanceof EntityOnOverlap)
                overlapCallbacks.add(() -> ((EntityOnOverlap) e).onOverlap(this, entity));
        });
    ...
    public void destroyEntity(Entity entity) {
        removeNode(entity);
        if (entity instanceof EntityOnDestroy) {
            ((EntityOnDestroy) entity).onDestroy(this);
        }
    }
