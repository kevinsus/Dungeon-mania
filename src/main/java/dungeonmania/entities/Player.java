...
public class Player extends Entity implements Battleable, EntityOnOverlap {
    ...
    public void triggerNext(int currentTick) {
        inEffective = queue.isEmpty() ? null : queue.remove();
        nextTrigger = state.triggerNext(currentTick, inEffective);
    }
