...
public class Entity {
    ...
    private SwampTile currentSwampTile;
    ...
    public SwampTile getCurrentSwampTile() {
        return currentSwampTile;
    }

    public void setCurrentSwampTile(SwampTile currentSwampTile) {
        this.currentSwampTile = currentSwampTile;
    }
